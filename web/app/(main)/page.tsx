...
const personSchema = {
  ...
  jobTitle: "Composer",
  description:
    "dl Salo is a composer creating music that interweaves classical piano, synthesizers, electronics and ambience.",
  address: {
    "@type": "PostalAddress",
    ...
    <div className="w-auto flex flex-col">
        ...
        <div className="flex md:flex-row flex-col gap-8 pt-2">
          ...
          <div className="flex flex-col gap-4 flex-1">
            <p>
              ...
              underpinned by heavy drums and operatic vocals, with ritualistic choir passages that
              lean on cult cinema and 1970s mystical aesthetics.
            </p>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div>
                12&quot; LP &middot; Cassette &middot; CD DigiPak &middot; Digital (24-bit/96kHz)
              </div>
            </div>

            <div className="flex flex-col gap-2 text-2xl">
              <a href="https://hologramopera.com/products/the-holy-sun-opera-house" target="_blank">
      ...
      <div className="bg-white rounded-md w-full p-8 mt-8">
        ...
        <div className="flex md:flex-row flex-col gap-8 pt-2">
          ...
          <div className="flex flex-col gap-4 flex-1">
            ...
            <p>
              With additional vocals by Krissy Barker. Recorded at Dead Flowers in Los Angeles and
      ...
      <div className="flex flex-col gap-8 h-auto mt-0 mb-20 md:mt-20">
        {features &&
          features.map(feature => (
            <div key={feature.slug} className="group flex flex-col gap-4 md:mx-8 p-4 card">
      ...
      {posts &&
        posts
          ...
          .map(post => (
            <div key={post.slug} className="group flex flex-col gap-4 md:mx-8 p-4 card">
